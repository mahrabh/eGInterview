<x-dark-layout>
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
            <h2 class="text-4xl font-black text-white tracking-tight">Recruitment</h2>
            <p class="text-slate-400 mt-2 text-sm font-medium">Manage imports, question generation, interview links, and evaluations.</p>
        </div>
        
        <div class="flex items-center gap-4">
            <form action="{{ route('recruitment.index') }}" method="GET" class="flex items-center gap-3">
