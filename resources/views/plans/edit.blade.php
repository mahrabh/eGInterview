    ...
    <div class="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4">
        <div class="w-full max-w-2xl">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 text-center md:text-left">
                <div>
                    <h2 class="text-4xl font-black text-white tracking-tight">Edit Plan: <span class="text-indigo-400">{{ $plan->name }}</span></h2>
                    <p class="text-slate-400 mt-2 text-sm font-medium">Modify plan details and usage limits.</p>
                </div>
                        ...
                        <div class="md:col-span-2 pt-4">
                            <label for="is_active" class="flex items-center gap-4 cursor-pointer group">
                                ...
                                <div class="relative flex items-center justify-center">
                                    <input id="is_active" type="checkbox" name="is_active" value="1" class="peer appearance-none w-7 h-7 border-2 border-slate-700 rounded-xl bg-slate-900/50 checked:bg-indigo-500 checked:border-indigo-500 transition-all cursor-pointer" {{ old('is_active', $plan->is_active) ? 'checked' : '' }}>
