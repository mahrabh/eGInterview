<x-dark-layout>
    <x-slot name="header">
        Plans Management
        <a href="{{ route('plans.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 border border-transparent rounded-xl font-bold text-xs text-white uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(79,70,229,0.3)]">
