<x-dark-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <span>Edit Recruiter: <span class="text-indigo-400">{{ $user->name }}</span></span>
    ...
    <div class="max-w-2xl">
        <div class="glass-panel border border-slate-800 rounded-[2rem] p-8 shadow-2xl">
            ...
            <div class="flex items-center gap-3 mb-8 pb-6 border-b border-slate-800">
                ...
                <span class="ml-auto px-3 py-1 text-[10px] font-bold uppercase tracking-widest rounded-full bg-slate-800 border border-slate-700 text-slate-400">Recruiter</span>
            </div>
